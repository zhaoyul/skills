...
description: 设置 Claude Code hooks 以在执行前阻止危险的 git 命令(push, reset --hard, clean, branch -D 等). 当用户想要防止破坏性 git 操作, 添加 git 安全 hooks, 提到 "git 护栏", "防误操作" 或在 Claude Code 中阻止 git push/reset 时使用.
---
