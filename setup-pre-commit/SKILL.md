...
description: 在当前仓库中使用 lint-staged(Prettier), 类型检查和测试设置 Husky pre-commit hooks. 当用户想要添加 pre-commit hooks, 设置 Husky, 配置 lint-staged, 添加提交时格式化/类型检查/测试, 提到 "提交前检查" 或 "提交钩子" 时使用.
---
